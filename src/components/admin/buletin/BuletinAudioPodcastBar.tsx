...
export const BuletinAudioPodcastBar: React.FC<BuletinAudioPodcastBarProps> = ({
  ...
  const narrativeScript = React.useMemo(() => {
    ...
    return [
      ...
      `Kata Pengantar Kepala KPPN: ${typeof buletinConfig.kataPengantar === 'string' ? buletinConfig.kataPengantar : buletinConfig.sambutanKepala || 'Pengelolaan perbendaharaan negara diarahkan pada penciptaan nilai tambah nyata bagi perekonomian regional serta peningkatan kualitas belanja yang akuntabel.'}`,
